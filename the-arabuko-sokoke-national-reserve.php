...
<head>
    ...
    <?php $article = 'the-arabuko-sokoke-national-reserve'; include __DIR__ . '/includes/article-seo.php'; ?>
    ...
    <style>
        ...
        .slideshow-image {
            ...
            width: 100%;
            height: 100%;
            background-image: url('images/Arabuko-Sokoke.png');
...
<body>
        ...
        <div class="container content-container">
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-8">
                    <h1 class="main-title">IMMERSE YOURSELF IN EXOTIC FOREST LIFE</h1>
                    <p class="subtitlee">Arabuko Sokoke National Reserve</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="banner-section">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-8">
                    <h1 class="banner-title">DISCOVER DIVERSE WILDLIFE</h1>
                    <p class="banner-description">Don’t miss your opportunity to wander into the Arabuko Sokoke National
                        Reserve, where the innumerable species of birds and other jungle creatures exist in harmony.
                        This excursion is perfect for avid birders and casual site-seers alike.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row g-0">
                ...
                <div class="col-12 col-lg-6">
                    <div class="content-box">
                        <h3 class="facility-title">GUIDED TOURS</h3>
                        <div class="divider"></div>
                        <p class="subtitle">See All the Best Spots</p>
                        <p class="mb-4 subtitle">For the best experience, choose an accompanying guide to lead the way
                            toward the very best locations. These experienced and knowledgeable guides provide expert
                            insight, making this activity as educational as it is exciting.</p>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-6" style="min-height: 50vh">
                    <div class="slider-container">
                        <img src="images/arabuko-sokoke-national-park-gede-ruins-museum.gif" alt="image 1"
                            class="slider-image active">
                        <img src="images/arabuko-sokoke-national-park-impala-antelope.gif" alt="image 2"
                            class="slider-image">
                        <img src="images/arabuko-sokoke-national-park-kenya-sokoke-scops-owl.gif" alt="image 3"
                            class="slider-image">
                        <img src="images/arabuko-sokoke-reserve-kenya.gif" alt="image 4" class="slider-image">
                    </div>
                </div>
            </div>
        </div>

...
/**
 * Property enquiry form (server-side PRG).
 ...
 * required a non-repo vendor/ dir (white-screen fatal off the old host) and
 * mailed to a hardcoded third-party address.
 */
$responseMessage = '';
$hide = 0;
        ...
        try {
            db_query(
                ...
                [
                    ...
                    ':payload'     => json_encode(['submitted_from' => $_SERVER['HTTP_REFERER'] ?? 'properties.php']),
                    ':source_page' => $tracking['source_page'] ?? 'properties.php',
            ...
            log_mail_error('properties.php enquiry failed: ' . $e->getMessage());

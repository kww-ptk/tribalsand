...
<head>
    ...
    <?php $article = 'the-traditional-swahili-dhow-cruise'; include __DIR__ . '/includes/article-seo.php'; ?>
    ...
    <style>
        ...
        .slideshow-image {
            ...
            width: 100%;
            height: 100%;
            background-image: url('images/Traditional-Swahili-sunset-dhow-cruise-1.jpg');
...
<body>
        ...
        <div class="container content-container">
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-8">
                    <h1 class="main-title">ENJOY AN EVENING ON THE WATER</h1>
                    <p class="subtitlee">Traditional Swahili Dhow Cruise</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="banner-section">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-8">
                    <h1 class="banner-title">SUSTAINABILITY MEETS ADVENTURE</h1>
                    <p class="banner-description">Kuruwitu’s sustainable conservation project serves as a multi-use experience, offering a variety of activities as diverse as its indigenous marine inhabitants. This destination is not only a must-see tourist attraction, but endeavors to support the socio-economic, environmental, and cultural needs of the surrounding area.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row g-0">
                ...
                <div class="col-12 col-lg-6">
                    <div class="content-box py-5">
                        <h3 class="facility-title">CRUISE THE KILIFI</h3>
                        <div class="divider"></div>
                        <p class="mb-4 subtitle">Join Captain Issa as he and his crew take you on an unforgettable trip on the reef or up the Kilifi Creek on a traditional Swahili dhow. These hand-carved sailboats are a must for anyone seeking an experience true to the Kenyan people.</p>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-6" style="min-height: 50vh">
                    <div class="slider-container">
                        <img src="images/04sp-travel-lamu-inyt-02-gkmz-videoSixteenByNine3000-scaled.jpg" alt="image 1" class="slider-image active">
                        <img src="images/shutterstock_1380915896-1-scaled-1-2048x1366-1.jpg" alt="image 2" class="slider-image">
                        <img src="images/10328.jpg" alt="image 3" class="slider-image">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    <img src="images/lamu-sunset-4.jpg" alt="Golf Course in Kenya" class="golf-image">
                </div>
                <div class="col-lg-6 ps-lg-5">
                    <h3 class="heading">SUNDOWN AND MOONLIT ADVENTURES</h3>
                    <div class="divider"></div>
                    <p class="subheading">Pick the Perfect Cruise</p>
                    <p class="subheading">Take in the warm light of the setting sun, or go on a moonlit expedition. Captain Issa and his crew will lead the way, providing additional opportunities to snorkel or fish upon request.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row g-0">
                ...
                <div class="col-lg-6">
                    <div class="content-box">
                        <h3 class="facility-title">TRADITIONAL SWAHILI MEAL</h3>
                        <div class="divider"></div>
                        <p class="subtitle">Eat Your Fill of Authentic Local Cuisine</p>
                        <p class="mb-4 subtitle">Enjoy dinner on the water, featuring a gourmet, sustainably-caught meal with the freshest of local pescatarian and vegetarian ingredients.</p>
                    </div>
                </div>

                <!-- Image Column -->
                <div class="col-lg-6">
                    <img src="images/396734576_765071345665092_2414859012077100462_n.jpg" alt="Golf Practice Facility" class="facility-image">
                </div>
            </div>
        </div>
    </section>

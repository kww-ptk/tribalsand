...
<head>
    ...
    <style>
        ...
        .slideshow-image {
            ...
            width: 100%;
            height: 100%;
            background-image: url('images/IMAGE-3_High-End-Adventure-Sports-in-Kenya-For-the-Luxury-Thrill-Seeker.webp');
...
<body>
        ...
        <div class="container content-container">
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-8">
                    <h1 class="main-title">PREMIER KITESURFING IN KILIFI, KENYA</h1>
                    <p class="subtitlee">The Complete Tropical Experience</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="banner-section">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-8">
                    <h1 class="banner-title">FEEL THE WIND ON YOUR SKIN</h1>
                    <p class="banner-description">Spice up your relaxing trip with a fast-paced expedition along the
                        Kilifi coastline. Skim the surface with fantastic waves and top-grade kitesurfing rentals for
                        all styles. When it’s time for a break, take it easy in the iconic Kilifi lagoons.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row g-0">
                ...
                <div class="col-12 col-lg-6">
                    <div class="content-box">
                        <h3 class="facility-title">PROFESSIONAL KITESURFING LESSONS</h3>
                        <div class="divider"></div>
                        <p class="subtitle">Learn to Ride like the Pros</p>
                        <p class="mb-4 subtitle">Kilifi’s ultimate kitesurfing experience is intimidation-free, offering
                            lessons from professional kitesurf instructors to hone your skills. Everyone can join in on
                            the fun, regardless of skill or previous experience.</p>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-6" style="min-height: 50vh">
                    <div class="slider-container">
                        <img src="images/Kitesurfing-1.jpg" alt="image 1" class="slider-image active">
                        <img src="images/Kitesurfing.jpg" alt="image 2" class="slider-image">
                        <img src="images/Kite-Surfing.jpg" alt="image 3" class="slider-image">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    <img src="images/SALTYSKITEVILLAGE_beachbarrestaurant.jpg" alt="Golf Course in Kenya" class="golf-image">
                </div>
                <div class="col-lg-6 ps-lg-5">
                    <h3 class="heading">BEACH BAR & RESTAURANT</h3>
                    <div class="divider"></div>
                    <p class="subheading">Take a Break in Luxury</p>
                    <p class="subheading">This essential destination will keep you busy all day long. Work up an
                        appetite and take advantage of a world-class beach bar and restaurant. After you’ve had your
                        fill, jump back in the water to keep the fun going.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="facility-section">
        <div class="container-fluid p-0">
            <div class="row g-0">
                ...
                <div class="col-12 col-lg-6">
                    <div class="content-box">
                        <h3 class="facility-title">VISIT WITH THE LOCALS</h3>
                        <div class="divider"></div>
                        <p class="subtitle">Authentic Kenyan Life</p>
                        <p class="mb-4 subtitle">Take a stroll to Kilifi town only 3km away and take in the authentic
                            atmosphere of daily Kenyan life. Spend time with the locals to enjoy their delicious
                            cuisine, vibrant market, and signature tea rooms.</p>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-6">
                        ...
                        <img src="images/kilifi_town__0.jpg" alt="image 1" class="golf-image">

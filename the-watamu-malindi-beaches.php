...
<head>
    ...
    <title>Watamu Malindi Beaches | TribalSand Villas Kenya</title>
     <meta name="description" content="Discover Watamu Malindi Beaches near TribalSand villas – famous for white sandy shores, turquoise waters, and world-class snorkeling, diving, and relaxation.">
    
    <link rel="icon" href="images/favicon.png">
    <!-- Canonical -->
    <link rel="canonical" href="https://tribalsand.com/watamu-malindi-beaches" />
    ...
    <style>
        ...
        .slideshow-image {
            ...
            width: 100%;
            height: 100%;
            background-image: url('images/IMAGE-3_Unforgettable-Coastal-Getaways-Exploring-Kenyas-Pristine-Beaches.webp');
...
<body>
        ...
        <div class="container content-container">
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-8">
                    <h1 class="main-title">TREAT YOURSELF TO A RELAXING DAY ON THE BEACH</h1>
                    <p class="subtitlee">Watamu-Malindi Beaches</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="banner-section">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-8">
                    <h1 class="banner-title">BURY YOUR TOES IN THE SAND</h1>
                    <p class="banner-description">Treat yourself to the epitome of vacation at the Watamu and Malindi beaches, where you can experience the ultimate comfort of the pleasant ocean breeze and velvety sand, or the vibrant local life at the neighboring Watamu and Malindi towns just 20km apart.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row g-0">
                ...
                <div class="col-12 col-lg-6">
                    <div class="content-box">
                        <h3 class="facility-title">KICK BACK ON THE BEACH</h3>
                        <div class="divider"></div>
                        <p class="subtitle">At Watamu and Malindi</p>
                        <p class="mb-4 subtitle">The Watamu and Malindi beaches are the ideal spots to spend your day basking under the Kenyan sun. With exceptionally clean and well-kept shores, gorgeous ocean horizons, and soothing climate, you’ll wonder why you planned on doing anything else at all.</p>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-6" style="min-height: 50vh">
                    <div class="slider-container">
                        <img src="images/IMAGE-2_Unforgettable-Coastal-Getaways-Exploring-Kenyas-Pristine-Beaches.webp" alt="image 1" class="slider-image active">
                        <img src="images/IMAGE-1-Restoration-of-Riparian-Habitat-on-Maya-Kobe-Beachfront-–-Bofa-Beach-Kilifi-Kenya.jpg" alt="image 2" class="slider-image">
                        <img src="images/Copy-of-42-min.jpg" alt="image 3" class="slider-image">
                        <img src="images/Copy-of-18-min-1.jpg" alt="image 4" class="slider-image">
                        <img src="images/beach-1868047_1280.jpg" alt="image 5" class="slider-image">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    <img src="images/nightlife-experience.jpg"
                        alt="Golf Course in Kenya" class="golf-image">
                </div>
                <div class="col-lg-6 ps-lg-5">
                    <h3 class="heading">EXPLORE THE TOWN OF MALINDI
                    </h3>
                    <div class="divider"></div>
                    <!-- <p class="subheading">Diverse Wildlife throughout the Course</p> -->
                    <p class="subheading">As the larger of the two towns, Malindi delivers the festive bustle and nightlife you’d expect from big city living. With casinos, restaurants, shopping areas, bars and nightclubs, you’ll have enough to keep you occupied for your entire stay.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="facility-section">
        <div class="container-fluid p-0">
            <div class="row g-0">
                ...
                <div class="col-lg-6">
                    <div class="content-box">
                        <h3 class="facility-title">EXPLORE THE TOWN OF WATAMU</h3>
                        <div class="divider"></div>
                        <!-- <p class="subtitle">Premier Coral Snorkeling</p> -->
                        <p class="mb-4 subtitle">For a more subdued experience, take a trip to Watamu and take in the peaceful life of the local fishing village. But don’t confuse relaxation for boredom. In addition to Watamu’s iconic beaches, you’ll discover delicious and authentic Kenyan seafood, as well as pubs and discos to keep you busy throughout the evenings.</p>
                    </div>
                </div>

                <!-- Image Column -->
                <div class="col-lg-6">
                    <img src="images/watamu_1-scaled.jpg" alt="Golf Practice Facility" class="facility-image">
                </div>
            </div>
        </div>
    </section>

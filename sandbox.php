...
<div class="page-wrap">
  ...
  <div class="page-main">
    ...
    <div class="sec">
      ...
      <h2 class="sec-h">Explore <em>Sandbox</em></h2>
      <div class="sec-rule"></div>
      <div class="photo-grid">
        <img src="images/hero-sandbox.jpg" alt="Sandbox outdoor and beach" onclick="openLb(0)">
        <img src="images/hero-sandbox.jpg" alt="Sandbox pool" onclick="openLb(1)">
        <img src="images/hero-sandbox.jpg" alt="Sandbox garden" onclick="openLb(2)">
      </div>
          ...
          <div class="enq-step" id="enqStep1">
            ...
            <div class="book-field">
              ...
              <select class="book-inp" id="enqRooms">
                <option value="">—</option>
                <option>1 Room</option><option>2 Rooms</option><option>3 Rooms</option><option>Full Villa</option>
              </select>
            </div>
...
(function(){
  ...
  document.getElementById('btnEnquire').addEventListener('click', function(){
    ...
    var noteLines = ['Tribal Dunes Enquiry'];
    ...
    fetch('/ghl-submit', { method:'POST', headers:{'Content-Type':'application/json'}, body: JSON.stringify({
      ...
      trip:    { prop: 'Tribal Dunes', arrival: arrival, departure: departure, adults: adults, children: children, rooms: rooms },
      message: message,
      tags:    ['website-enquiry', 'tribal-dunes-enquiry'],
      opportunity: { source: 'Website - Tribal Dunes' },
      note:    noteLines.join('\n'),
      ref:     'WEB-' + Date.now()
    })})

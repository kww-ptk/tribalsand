        ...
        <tr>
          ...
          <td>
            <div class="row-actions" style="flex-wrap:wrap;gap:6px">
              <a href="/admin/submissions.php?agent_id=<?= $id ?>" class="btn-icon btn-icon--outline" title="View this agent's requests" aria-label="View requests"><?= admin_icon('message') ?></a>

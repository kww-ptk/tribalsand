...
<head>
    ...
    <?php $article = 'discover-maya-kobe-where-secluded-luxury-meets-the-ocean-breeze'; include __DIR__ . '/includes/article-seo.php'; ?>
...
<body>
    ...
    <div class="container content-section">
        <div class="row">
            <div class="col-12">
                <p>
                    Imagine a place where the rhythmic sound of waves lulls you into
                    tranquility, where every detail of your surroundings exudes
                    sophistication and comfort, and where your only responsibility is to
                    unwind and embrace the beauty of nature. Welcome to Maya Kobe, one
                    of TribalSand’s most coveted luxury villas, nestled along the
                    pristine shores of Kilifi, Kenya.
                </p>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row mt-4">
            <div class="col-12">
                <h2>A Secluded Haven</h2>
                <p>
                    Maya Kobe is more than just a villa; it’s a secluded haven designed
                    for those who crave peace and privacy without compromising on
                    luxury. Tucked away in Kilifi, this villa offers an intimate escape
        ...
        <div class="row mt-4">
            <div class="col-12">
                <h2>Experience Kilifi’s Natural Wonders</h2>
                <p>
                    Kilifi is a region teeming with natural wonders, from the
                    crystal-clear waters of the Indian Ocean to the rich marine life
                    that thrives in its coral reefs. Whether you’re an adventurer or a
                    relaxation seeker, Kilifi offers it all.
                </p>
            </div>
        </div>
        <div class="footerr">
            <h2>Ready to escape to your private paradise?</h2>

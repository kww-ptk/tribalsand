...
<head>
    ...
    <style>
        ...
        .slideshow-image {
            ...
            width: 100%;
            height: 100%;
            background-image: url('images/dolphin_3-e1714744888426.jpg');
...
<body>
        ...
        <div class="container content-container">
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-8">
                    <h1 class="main-title">SEE THE DOLPHINS AS THEY WERE MEANT TO BE SEEN</h1>
                    <p class="subtitlee">Watamu Dolphin Safari</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="banner-section">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-8">
                    <h1 class="banner-title">BREAK FREE FROM THE CAGE</h1>
                    <p class="banner-description">At Watamu’s Marine Haven Sanctuaries, you’ll see the dolphins in a
                        natural setting that honors their dignity while still delivering a thrilling adventure on the
                        water. All the while your guides will educate you on the nature preserve, providing a memorable
            ...
            <div class="row g-0">
                ...
                <div class="col-12 col-lg-6">
                    <div class="content-box">
                        <h3 class="facility-title">AN UNDERWATER PARADISE</h3>
                        <div class="divider"></div>
                        <p class="subtitle">Premier Coral Snorkeling</p>
                        <p class="mb-4 subtitle">Take a plunge beneath the surface to discover a utopia of marine life,
                            including hundreds of species of fish, populations of sea turtles, and a protected coral
                            reef that has returned to thriving for over 11 years.</p>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-6" style="min-height: 50vh">
                    <div class="slider-container">
                        <img src="images/shifaz-abdul-hakkim-NZTsrLSgNv0-unsplash.jpg" alt="image 1"
                            class="slider-image active">
                        <img src="images/Snorkelling.jpg" alt="image 2" class="slider-image">
                        <img src="images/dolphins-4368918_1280.jpg" alt="image 3" class="slider-image">
                    </div>
                </div>
            </div>
        </div>

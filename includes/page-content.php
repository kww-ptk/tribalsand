    ...
    return [
        ...
        'sustainability' => [
            ...
            'groups' => [
                'Hero' => [
                    'hero_image' => ['type'=>'image', 'label'=>'Hero background photo',
                        'hint'=>'Full-width photo behind the heading, with a dark teal gradient over it. Use a wide landscape shot.',
                        'default'=>'images/New-hero-banner.jpg'],
                    'hero_eyebrow' => ['type'=>'text', 'label'=>'Eyebrow', 'default'=>'Our Commitment'],
                    'hero_title' => ['type'=>'html', 'label'=>'Headline (H1)',
                        'hint'=>'The page\'s only H1 — keep the main keyword in it. &lt;em&gt; makes the italic gold part.',
                        'default'=>'Sustaining Kenya\'s <em>Coastline</em>'],
                    'hero_sub' => ['type'=>'html', 'label'=>'Sub-heading',
                        'hint'=>'The &middot; separators are plain text.',
                        'default'=>'Solar powered &middot; Ocean water &middot; Zero single-use plastic &middot; Beach clean &middot; Coral restoration &middot; Turtle conservation'],
                ],
                'Sections' => [
                    'solar_eyebrow' => ['type'=>'text','label'=>'Solar — eyebrow','default'=>'Energy'],
                    'solar_title' => ['type'=>'html','label'=>'Solar — heading',
                        'default'=>'Solar-Powered <em>Hospitality</em>'],
                    'beach_eyebrow' => ['type'=>'text','label'=>'Conservation — eyebrow','default'=>'Conservation'],
                    'beach_title' => ['type'=>'html','label'=>'Conservation — heading',
                        'default'=>'Protecting the <em>Reef &amp; Shore</em>'],
                    'farm_eyebrow' => ['type'=>'text','label'=>'Farm to Table — eyebrow','default'=>'Farm to Table'],
                    'farm_title' => ['type'=>'html','label'=>'Farm to Table — heading',
                        'default'=>'Grown Where It Is <em>Served</em>'],
                ],
                'Sharing' => [
                    'og_image' => ['type'=>'image', 'label'=>'Social share image',
                        'hint'=>'Shown when the page is shared. Not visible on the page itself.',
                        'default'=>'images/maya_illai/Best1.jpg'],
                ],
            ],
        ],
        'zuri-restaurant' => [
            ...
            'groups' => [
                ...
                'The food' => [
                    'food_eyebrow' => ['type'=>'text', 'label'=>'Eyebrow',
                        'default'=>'Coastal À La Carte · Watamu'],
                    'food_title' => ['type'=>'html', 'label'=>'Heading',
                        'hint'=>'&lt;em&gt; makes the italic gold part.',
                        'default'=>'A menu that starts <em>at the shoreline</em>'],
                    'food_body' => ['type'=>'html', 'label'=>'Paragraph',
                        'default'=>'Zuri cooks the coast it sits on. Seafood comes in from the Watamu boats, vegetables and fruit from farms along the Kilifi road, and the spice notes are the ones the Swahili coast has used for centuries — tamarind, coconut, cardamom, lime. The à la carte menu changes with what the day actually brings in, which is why we keep it short and cook it properly.'],
                    'food_body2' => ['type'=>'html', 'label'=>'Second paragraph',
                        'default'=>'Lunch is relaxed and barefoot, served by the pool with the garden around you. Dinner slows the pace down — candlelight, the sound of the reef, and a room small enough that the kitchen can look after every table on it.'],
                    'food_image' => ['type'=>'image', 'label'=>'Photo',
                        'hint'=>'Sits beside the text on desktop, above it on mobile.',
                        'default'=>'images/zuri/Garden/zuri.watamu.morning.pool-10.webp'],
                    'food_facts' => ['type'=>'text', 'label'=>'Tags',
                        'hint'=>'Separate each one with a vertical bar |',
                        'default'=>'Fresh Seafood | Swahili Coastal | Vegetarian on Request | Dietary Needs Catered | Lunch & Dinner'],
                ],
                'Celebrations' => [
                    'occ_eyebrow' => ['type'=>'text', 'label'=>'Eyebrow',
                        'default'=>'Private by Nature'],
                    'occ_title' => ['type'=>'html', 'label'=>'Heading',
                        'default'=>'Kept for <em>the occasion</em>'],
                    'occ_body' => ['type'=>'html', 'label'=>'Paragraph',
                        'default'=>'Reservation-only is not exclusivity for its own sake — it is how the room stays quiet. Zuri seats a handful of tables on a private beachfront terrace, so the evening belongs to the people at them rather than to a crowd. It is why guests choose us among restaurants in Watamu for the dinners that matter: anniversaries, birthdays, a proposal at the water\'s edge, the last night of a holiday.'],
                    'occ_body2' => ['type'=>'html', 'label'=>'Second paragraph',
                        'default'=>'Tell us what you are marking when you reserve — there is a note field on the form below. Flowers on the table, a cake brought out at the right moment, a quieter corner, a dietary requirement handled without fuss: say the word and we will arrange it before you arrive.'],
                    'occ_image' => ['type'=>'image', 'label'=>'Photo',
                        'default'=>'images/zuri/Beach/zuri.watamu.beach-2.webp'],
                    'occ_facts' => ['type'=>'text', 'label'=>'Tags',
                        'hint'=>'Separate each one with a vertical bar |',
                        'default'=>'Anniversaries | Birthdays | Proposals | Private Terrace | Intimate Seating'],
                ],
                'Gallery' => [
            ...
            'groups' => [
                ...
                'The kitchen' => [
                    'kitchen_image' => ['type'=>'image', 'label'=>'Kitchen photo',
                        ...
                        'default'=>'images/maya_illai/SITE PHOTOS BAR AND POOL-images-1.jpg'],
                ...
                'The team' => [
                    ...
                    'team_title' => ['type'=>'html', 'label'=>'Heading',
                        'default'=>'The quiet art of <em>looking after you</em>'],
                    'team_body' => ['type'=>'html', 'label'=>'Paragraph',
                        'default'=>'Our team is of this coast — most of them from within a few kilometres of the beach they work on — and they bring an unhurried, genuinely warm kind of care to the room. Nothing is rushed and nothing is scripted. They learn how you take your coffee, remember the wine you liked, and notice what you need before you have to ask for it. That attentiveness, more than anything on the menu, is what brings people back.'],
                ],
                'Gallery' => [
                    ...
                    'gal_1' => ['type'=>'image','label'=>'Gallery photo 1',
                        ...
                        'default'=>'images/maya-kobe/Maya Kobe - Day Outdoor, Pool, Beach/Maya Kobe Best4.jpg'],
                    'gal_2' => ['type'=>'image','label'=>'Gallery photo 2',
                        'hint'=>'Suggested: the restaurant seen from the garden.', 'default'=>'images/maya-kobe/Aerial/mayakobe-2.webp'],
                    'gal_3' => ['type'=>'image','label'=>'Gallery photo 3',
                        'hint'=>'Suggested: the cocktail close-up.', 'default'=>'images/maya_illai/Best1.jpg'],
                    'gal_4' => ['type'=>'image','label'=>'Gallery photo 4',
                        'hint'=>'Suggested: guests at the table after dark.', 'default'=>'images/maya_illai/Best4.jpg'],
                    'gal_5' => ['type'=>'image','label'=>'Gallery photo 5',
                        'hint'=>'Suggested: the dining room and bar at dusk.', 'default'=>'images/maya_illai/best5.jpg'],
                    'gal_6' => ['type'=>'image','label'=>'Gallery photo 6',
                        'hint'=>'Spare slot — clear it to drop the tile from the grid.', 'default'=>'images/maya_illai/Best9.jpg'],
                ],
                'Sharing' => [
                    'og_image' => ['type'=>'image', 'label'=>'Social share image',
                        'hint'=>'Shown when the page is shared. Not visible on the page itself.',
        ...
        'tribal-gym' => [
            ...
            'groups' => [
                'Hero' => [
                    'hero_image' => ['type'=>'image', 'label'=>'Hero photo',
                        'hint'=>'Stand-in until the gym is photographed — swap in a shot of the training floor.',
                        'default'=>'images/maya-kobe/Maya Kobe - Day Outdoor, Pool, Beach/Maya Kobe Best3.jpg'],
                    'hero_badge' => ['type'=>'text', 'label'=>'Status badge',
                        'hint'=>'The pill above the heading. Change to "Now Open" at launch.',
                        'default'=>'Coming Soon'],
                    'hero_eyebrow' => ['type'=>'text', 'label'=>'Eyebrow',
                        'default'=>'Tribal Dunes · Bofa Beach · Kilifi'],
                    'hero_title' => ['type'=>'html', 'label'=>'Headline (H1)',
                        'hint'=>'&lt;em&gt; makes the italic gold part.',
                        'default'=>'Tribal <em>GYM</em> is coming to Tribal Dunes'],
                    'hero_sub' => ['type'=>'textarea', 'label'=>'Intro',
                        'default'=>'A new place to train, recharge, and spend the day in Kilifi. Tribal GYM will bring brand-new equipment, air conditioning, personal training, and showers together with the coastal lifestyle at Tribal Dunes.'],
                    'hero_facts' => ['type'=>'text', 'label'=>'Tags',
                        'hint'=>'Separate each one with a vertical bar |',
                        'default'=>'Brand-New Equipment | Air Conditioning | Personal Training | Showers | Swimming Pool | Chill-Out Area'],
                ],
                'After your workout' => [
                    'after_body' => ['type'=>'html', 'label'=>'Paragraph',
                        'hint'=>'May carry a link, e.g. &lt;a href="somewhere-cafe.php"&gt;.',
                        'default'=>'After your workout, unwind by the swimming pool or in the chill-out area, and stop by <a href="somewhere-cafe.php">Somewhere Café</a> for healthy food.'],
                ],
                'Memberships' => [
                    'plans_title' => ['type'=>'html', 'label'=>'Heading',
                        'default'=>'Find your way to <em>train</em>'],
                    'plan1_image'=> ['type'=>'image',    'label'=>'Option 1 — photo',
                        'hint'=>'Stand-in. Suggested: a guest mid-workout on the training floor. Type a single - to show the card without a photo.',
                        'default'=>'images/maya_illai/Best1.jpg'],
                    'plan1_name' => ['type'=>'text',     'label'=>'Option 1 — name', 'default'=>'Day Pass'],
                    'plan1_desc' => ['type'=>'textarea', 'label'=>'Option 1 — text', 'default'=>'Drop in for a workout when it suits you.'],
                    'plan1_price'=> ['type'=>'text',     'label'=>'Option 1 — price',
                        'hint'=>'Leave empty until prices are announced — the line is hidden when blank.', 'default'=>''],
                    'plan2_image'=> ['type'=>'image',    'label'=>'Option 2 — photo',
                        'hint'=>'Stand-in. Suggested: the weights area or a personal-training session. Type a single - to show the card without a photo.',
                        'default'=>'images/maya_illai/best5.jpg'],
                    'plan2_name' => ['type'=>'text',     'label'=>'Option 2 — name', 'default'=>'Monthly Membership'],
                    'plan2_desc' => ['type'=>'textarea', 'label'=>'Option 2 — text', 'default'=>'Make Tribal GYM part of your routine.'],
                    'plan2_price'=> ['type'=>'text',     'label'=>'Option 2 — price',
                        'hint'=>'Leave empty until prices are announced — the line is hidden when blank.', 'default'=>''],
                    'plan3_image'=> ['type'=>'image',    'label'=>'Option 3 — photo',
                        'hint'=>'Stand-in. Suggested: the pool or chill-out area — the premium lifestyle. Type a single - to show the card without a photo.',
                        'default'=>'images/maya_illai/Best9.jpg'],
                    'plan3_name' => ['type'=>'text',     'label'=>'Option 3 — name', 'default'=>'Yearly Premium Membership'],
                    'plan3_desc' => ['type'=>'textarea', 'label'=>'Option 3 — text', 'default'=>'Commit to a full year of training and enjoy our premium membership option.'],
                    'plan3_price'=> ['type'=>'text',     'label'=>'Option 3 — price',
                        'hint'=>'Leave empty until prices are announced — the line is hidden when blank.', 'default'=>''],
                    'plans_note' => ['type'=>'text', 'label'=>'Note under the options',
                        'hint'=>'Type a single - to hide it once prices are published.',
                        'default'=>'Prices and full package details will be announced soon.'],
                ],
                'Waitlist' => [
                    'wl_title'   => ['type'=>'html', 'label'=>'Heading', 'default'=>'Early access to <em>Tribal Gym</em>'],
                    'wl_body'    => ['type'=>'textarea', 'label'=>'Text',
                        'default'=>'Join the waitlist for early access to launch pricing and membership details.'],
                    'wl_button'  => ['type'=>'text', 'label'=>'Button', 'default'=>'Join the waitlist'],
                    'wl_success' => ['type'=>'text', 'label'=>'Thank-you message',
                        'default'=>'You\'re on the list. We\'ll be in touch with launch pricing and membership details.'],
                ],
                'Closing photo' => [
                    'band_image' => ['type'=>'image', 'label'=>'Full-width photo',
                        'hint'=>'The wide image under the waitlist. Type a single - to hide the band.',
                        'default'=>'images/maya-kobe/Aerial/mayakobe-2.webp'],
                    'band_caption' => ['type'=>'text', 'label'=>'Caption over the photo',
                        'hint'=>'Type a single - for the photo alone.',
                        'default'=>'Train · Swim · Unwind — Tribal Dunes, Kilifi'],
                ],
                'Sharing' => [
                    'og_image' => ['type'=>'image', 'label'=>'Social share image',
                        'hint'=>'Shown when the page is shared. Not visible on the page itself.',

...
<head>
    ...
    <?php $article = 'the-pga-baobab-golf-course'; include __DIR__ . '/includes/article-seo.php'; ?>
        ...
        <div class="container content-container">
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-8">
                    <h1 class="main-title">THE PGA BAOBAB GOLF COURSE</h1>
                    <p class="subtitlee">A Golfing Experience Unlike Any Other</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-8">
                    <h1 class="banner-title">
                        KENYA'S ONLY ACCREDITED<br>
                        PGA GOLF COURSE
                    </h1>
                    <p class="banner-description">
                        The course at Vipingo Ridge is the premier destination for golf lovers, casual players, and
                        site-seers alike. This 18-hole PGA championship course sports countless breathtaking vistas and
                        a challenging 72 par course that every golf aficionado needs to check off their bucket list.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="row g-0">
                ...
                <div class="col-12 col-lg-6">
                    <div class="content-box">
                        <h3 class="facility-title">DRIVING RANGE AND PRACTICE FACILITIES</h3>
                        <div class="divider"></div>
                        <p class="subtitle">Perfect for Players at All Levels</p>
                        <p class="mb-4 subtitle">This gorgeous plot of land at Vipingo Ridge offers fun opportunities
                            for anyone to get a satisfying golfing experience. Play leisurely with a wide set of options
                            to hone your skills, featuring:</p>
                        <ul class="facility-list subtitle">
                            <li>Practice tee stretching 300 meters long</li>
                            <li>Short game and bunker practice area</li>
                            <li>Accredited PGA Academy for all ages</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-6" style="min-height: 50vh">
                    <div class="slider-container">
                        <img src="images/tn_PGA-golf-1024x530-1.png" alt="image 1" class="slider-image active">
                        <img src="images/LET_2022_-4_du5eu0.jpg" alt="image 2" class="slider-image">
                        <img src="images/MKLODAY2-4885.jpg" alt="image 3" class="slider-image">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    <img src="images/220504133243-02-zebra-fairway-vipingo-ridge-golf-africa-spt-intl-restricted.jpg"
                        alt="Golf Course in Kenya" class="golf-image">
                </div>
                <div class="col-lg-6 ps-lg-5">
                    <h3 class="heading">GOLF WITH A UNIQUELY KENYAN TWIST</h3>
                    <div class="divider"></div>
                    <p class="subheading">Diverse Wildlife throughout the Course</p>
                    <p class="subheading">You'll never golf alone with this hybrid wildlife sanctuary course, sanctioned
                        by the Kenya Wildlife Services. Indigenous animals of all kinds roam the fields to spark wonder
                        at every corner, giving you a golfing experience that you'll never forget.</p>
                </div>
            </div>
        </div>
    </section>

<?php
$booking_slug = 'my-amani-superior-garden-view-twin';
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <section class="hero-section">
        <div class="container">
            ...
            <h2 class="hero-subtitle">Superior Garden View Room</h2>
        </div>
    </section>
                ...
                <div class="col-12 col-lg-6">
                    <div class="hero-section2">
                        <div class="content-wrapper">
                            <h1 class="main-title">AN ELEVATED ESCAPE AMIDST NATURE</h1>
                            <div class="description">
                                <p>Discover the <i> Superior Garden View Room</i>, where luxury meets nature in perfect
                                    harmony. Located within the lush gardens of <i>My Amani</i>, this room offers
                                    expansive garden views and an enhanced level of comfort, making it the perfect
                                    sanctuary for those who want both tranquility and indulgence.</p>
                            </div>
                            <div class="d-flex">
    ...
    <section class="amenities-section">
        <div class="container">
            <h2 class="section-title">PREMIUM AMENITIES IN YOUR GARDEN SANCTUARY</h2>

            <p class="text-left intro-text">
                With your stay at My Amani’s Superior Garden View Room, you’ll enjoy the very best that luxury vacation
                has to offer:
            </p>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="amenity-item">
                        ...
                        <div class="amenity-text">
                            <h5>
                            Private Balcony with panoramic views of the beautifully landscaped gardens</h5>
                        </div>
                    </div>
                    <div class="amenity-item">
                        <div class="amenity-icon">

<?php
$booking_slug = 'my-amani-superior-sea-view-twin';
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <section class="hero-section">
        <div class="container">
            ...
            <h2 class="hero-subtitle">SUPERIOR SEA VIEW ROOM</h2>
        </div>
    </section>
                ...
                <div class="col-12 col-lg-6">
                    <div class="hero-section2">
                        <div class="content-wrapper">
                            <h1 class="main-title">INDULGE IN LUXURY WITH PANORAMIC OCEAN VIEWS</h1>
                            <div class="description">
                                <p>Discover the <i>Superior Sea View Room</i>, a premier choice at <i>My Amani</i>, offering expansive views of the Indian Ocean. Positioned to capture breathtaking vistas and an enhanced level of comfort, this room is the ideal retreat for guests seeking a blend of elegance and natural beauty.</p>
                            </div>
                            <div class="d-flex">
    ...
    <section class="amenities-section">
        <div class="container">
            ...
            EXCLUSIVE AMENITIES IN YOUR OCEANFRONT SANCTUARY</h2>

            <p class="text-left intro-text">
            With your stay at My Amani’s Superior Sea View Room, you’ll enjoy the very best that luxury vacationing has to offer:
            </p>

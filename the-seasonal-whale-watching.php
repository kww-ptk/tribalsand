...
<head>
    ...
    <?php $article = 'the-seasonal-whale-watching'; include __DIR__ . '/includes/article-seo.php'; ?>
    ...
    <style>
        ...
        .slideshow-image {
            ...
            width: 100%;
            height: 100%;
            background-image: url('images/humpback-whale-436120_1280.webp');
...
<body>
        ...
        <div class="container content-container">
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-8">
                    <h1 class="main-title">MAKE A SPLASH</h1>
                    <p class="subtitlee">Seasonal Whale Watching</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="banner-section">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-8">
                    <h1 class="banner-title">TAKE IN THE MAJESTY</h1>
                    <p class="banner-description">The humpback whale is one of the most majestic animals in all the
                        ocean, and you have a chance to take in their beauty during their annual pass through the Watamu
                        Protected Area on the Kenyan Coast.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row g-0">
                ...
                <div class="col-12 col-lg-6">
                    <div class="content-box">
                        <h3 class="facility-title">SAIL OUT ONTO THE WATER</h3>
                        <div class="divider"></div>
                        <p class="subtitle">On a Guided Whale Watching Tour</p>
                        <p class="mb-4 subtitle">Take a trip out on the water to catch the humpbacks on their annual
                            migration north from the arctic. Your guide will bring you to the whale watching hotzones to
                            maximize your chances of seeing the magnificent creatures make a splash on the scene.</p>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-6" style="min-height: 50vh">
                    <div class="slider-container">
                        <img src="images/201219212607-finding-whales-in-kenya9-watamu-marine-association.jpg"
                            alt="image 1" class="slider-image active">
                        <img src="images/whale_3.jpg" alt="image 2" class="slider-image">
                        <img src="images/whale_10.jpg" alt="image 3" class="slider-image">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    <img src="images/whale_2.jpg" alt="Golf Course in Kenya" class="golf-image">
                </div>
                <div class="col-lg-6 ps-lg-5">
                    <h3 class="heading">LOOK OUT FOR WHALES OF ALL KINDS</h3>
                    <div class="divider"></div>
                    <p class="subheading">Extensive Whale Biodiversity</p>
                    <p class="subheading">In addition to Kenya’s display of beautiful humpback whales, keep your eyes
                        peeled on your oceanic survey for even more spectacular species. Those with a keen eye might
                        find killer whales, sperm whales, and Bryde’s whales lurking throughout the crystal blue waters.
                    </p>
                </div>
            </div>
        </div>

...
<head>
    ...
    <style>
        ...
        .slideshow-image {
            ...
            width: 100%;
            height: 100%;
            background-image: url('images/Snorkelling-2.jpg');
...
<body>
        ...
        <div class="container content-container">
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-8">
                    <h1 class="main-title">EXPLORE THE KURUWITU CONSERVANCY</h1>
                    <p class="subtitlee">Snorkeling and Kayaking in a Marine Utopia</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="banner-section">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-md-10 col-lg-8">
                    <h1 class="banner-title">SUSTAINABILITY MEETS ADVENTURE
                    </h1>
                    <p class="banner-description">
                    Kuruwitu’s sustainable conservation project serves as a multi-use experience, offering a variety of activities as diverse as its indigenous marine inhabitants. This destination is not only a must-see tourist attraction, but endeavors to support the socio-economic, environmental, and cultural needs of the surrounding area.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="row g-0">
                ...
                <div class="col-12 col-lg-6">
                    <div class="content-box">
                        ...
                        <p class="mb-4 subtitle">Take a plunge beneath the surface to discover a utopia of marine life, including hundreds of species of fish, populations of sea turtles, and a protected coral reef that has returned to thriving for over 11 years.</p>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-6" style="min-height: 50vh">
                    <div class="slider-container">
                        <img src="images/Kuruwitu-Conservancy.jpg" alt="image 1" class="slider-image active">

<?php
$booking_slug = 'my-amani-premium-sea-view-twin';
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <section class="hero-section">
        <div class="container">
            ...
            <h2 class="hero-subtitle">Premium SEA VIEW ROOM</h2>
        </div>
    </section>
                ...
                <div class="col-12 col-lg-6">
                    <div class="hero-section2">
                        <div class="content-wrapper">
                            <h1 class="main-title">UNMATCHED LUXURY WITH SWEEPING OCEAN VISTAS</h1>
                            <div class="description">
                                <p>Discover  <i>Premium Sea View Room</i>, offers the best of <i>My Amani's</i> oceanfront accommodations, providing stunning, uninterrupted views of the Indian Ocean. This space is designed for those who seek a luxurious escape with unmatched scenery.</p>
                            </div>
                            <div class="d-flex">
    ...
    <section class="amenities-section">
        <div class="container">
            ...
            PREMIUM AMENITIES WITH AN OCEANFRONT VIEW</h2>

            <p class="text-left intro-text">
            With your stay at My Amani’s Premium Sea View Room, you’ll enjoy the very best that luxury vacationing has to offer:
            </p>

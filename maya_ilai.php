...
.book-pol-row{display:flex;justify-content:space-between;align-items:center;padding:.55rem .85rem;border-bottom:1px solid var(--border);font-size:.82rem;}
...
<div class="page-wrap">
  ...
  <div class="page-main">
    ...
    <!-- Header -->
    <div class="listing-eyebrow">Eco Retreat Compound · Solar Powered · Adults 16+</div>
    ...
    <div class="sec">
      ...
      <h2 class="sec-h">Best Eco Retreat Compound in <em>Kilifi, Kenya</em></h2>
      <div class="sec-rule"></div>
      <p class="sec-p">Maya Ilai is a solar-powered eco retreat compound nestled at the back of the Tribal Dunes property in Kilifi — Kenya's most exciting beachfront destination. With 16 units across three-bedroom villas and studio apartments, it is designed for groups, conscious travellers and anyone seeking flexible, affordable longer-term coastal living without sacrificing comfort or community.</p>
      <p class="sec-p">The beach is a short five-minute walk through Somewhere Café. Electric bikes and golf carts are on hand for guests who prefer a ride. A large communal pool, bar and garden spaces form the heart of the compound — places where corporate retreat delegates, kitesurf campers, and wellness seekers naturally gather.</p>
      <p class="sec-p">Every kilowatt of energy here is generated by the sun. Fresh water is desalinated from the ocean. Rainwater is harvested. And the nearby coral restoration project is part of an active commitment to the ocean that surrounds this place. Maya Ilai is sustainable hospitality done with integrity.</p>
    </div>
      ...
      <div class="book-body">
        ...
        <div class="book-enquiry" id="enqWrap">
          ...
          <div class="enq-step" id="enqStep1">
            ...
            <div class="book-field">
              <label class="book-lbl" for="enqRooms">Unit Type</label>
              <select class="book-inp" id="enqRooms">
                <option value="">—</option>
                <option>Studio</option><option>Villa</option><option>Multiple Units</option><option>Full Compound</option>
              </select>
            </div>
...
<div class="sticky-cta" id="stickyCta">
  ...
  <a href="#rrBar" class="sticky-cta-btn">Book →</a>
</div>
...
(function(){
  ...
  document.getElementById('btnEnquire').addEventListener('click', function(){
    ...
    var noteLines = ['Maya Ilai Enquiry'];
    ...
    fetch('/ghl-submit', { method:'POST', headers:{'Content-Type':'application/json'}, body: JSON.stringify({
      ...
      trip:    { prop: 'Maya Ilai', arrival: arrival, departure: departure, adults: adults, children: children, rooms: rooms },
      message: message,
      tags:    ['website-enquiry', 'maya-ilai-enquiry'],
      opportunity: { source: 'Website - Maya Ilai' },
      note:    noteLines.join('\n'),
      ref:     'WEB-' + Date.now()
    })})

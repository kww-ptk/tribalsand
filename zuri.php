...
.book-pol-row{display:flex;justify-content:space-between;align-items:center;padding:.55rem 1.6rem .55rem 1.7rem;border-bottom:1px solid var(--border);font-size:1rem;}
  ...
  <aside class="page-side" id="book" style="scroll-margin-top:90px">
    <div class="book-card">
      ...
      <div class="book-body" style="padding:0">
        <?php $pa_venue_slug = 'zuri'; include __DIR__ . '/includes/property-availability-widget.php'; ?>
      </div>
